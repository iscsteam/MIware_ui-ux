...
//     // Check if the URL needs to be adjusted with an /api prefix
//     const response = await fetch(`${baseUrl}/dags/dag_test14_65308242`, {
//       method: "PUT",
//       headers: {
//         "Content-Type": "application/json",
//       },
...
//     const response = await fetch(`${baseUrl}/dag_runs/dag_test14_65308242/trigger_run`, {
//       method: "POST",
//       headers: {
//         "Content-Type": "application/json",
//       },
...
//     // Check if the URL needs to be adjusted with an /api prefix
//     const response = await fetch(`${baseUrl}/dags/dag_sample_47220ca3`, {
//       method: "PUT",
//       headers: {
//         "Content-Type": "application/json",
//       },
...
//     // Use the correct endpoint
//     const response = await fetch(`${baseUrl}/dag_runs/dag_sample_47220ca3/trigger_run`, {
//       method: "POST",
//       headers: {
//         "Content-Type": "application/json",
//       },
