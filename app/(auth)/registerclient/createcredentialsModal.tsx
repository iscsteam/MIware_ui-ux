...
import { createCredentials, type CredentialCreate, type CredentialOut } from "@/services/client"
...
export function CreateCredentialsModal({ open, onOpenChange }: CreateCredentialsModalProps) {
  ...
  const [createdCredential, setCreatedCredential] = useState<CredentialOut | null>(null)
          ...
          <div className="grid gap-4 py-4">
            <div className="bg-green-50 border border-green-200 rounded-md p-4">
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                ...
                <span className="text-green-800">{createdCredential.email}</span>
                
                <span className="text-green-700 font-medium">Role:</span>
                <span className="text-green-800 capitalize">{createdCredential.role}</span>
                
                <span className="text-green-700 font-medium">Client ID:</span>
                <span className="text-green-800 text-xs break-all">{createdCredential.unique_client_id}</span>
                
                <span className="text-green-700 font-medium">Created:</span>
                <span className="text-green-800 text-xs">{formatDate(createdCredential.created_at)}</span>
