  ...
  inputSchema: [
    {
      ...
      datatype: "string",
      description:
        "Database provider (e.g., postgresql, mysql, sqlserver, oracle, local).",
      required: true,
    },
    {
      name: "format",
...
export default function DatabaseNodeProperties({ formData, onChange }: Props) {
  ...
  // useEffect(() => {
  //   if (formData.provider && databaseProviders[formData.provider]) {
  //     const providerDefaults = databaseProviders[formData.provider];
  //     if (!formData.batchSize || formData.batchSize === "5000") {
  //       onChange("batchSize", providerDefaults.batchsize);
  //     }
  //   }
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Select
          value={formData.provider || "postgresql"}
      ...
      <div className="space-y-2">
        ...
        <Select
          value={formData.writeMode || "overwrite"}
          onValueChange={(value) => onChange("writeMode", value)}
        >
      ...
      <div className="space-y-2 p-3 border rounded-md bg-blue-50">
        ...
        <p className="text-xs text-blue-600">
          This database node can receive file data from a connected read-file
          node. When connected, uploaded files will be automatically processed
          and inserted into the specified table.
        </p>
