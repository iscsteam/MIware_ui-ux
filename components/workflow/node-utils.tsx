...
// }
"use client"
import { Filter, FileInput, Code, Server, Send, Globe, FileJson, FileCode, Database, FilePenLine } from "lucide-react"
...
export function getNodeIcon(type: NodeType) {
  ...
  // If type is in pngIconMap, render <img>
  if (pngIconMap[type]) {
    return <img src={pngIconMap[type]! || "/placeholder.svg"} alt={type} className={iconClass} draggable={false} />
  }
