...
import {Play, FileText, FileInput, FileOutput, Copy, CheckCircle, X, Search, ChevronDown, ChevronRight, FolderPlus, File, FileEdit, FilePlus2, FolderOpen, Trash2, Files, Clock, Server, Send, Globe} from "lucide-react"
...
export function SideModal({ isOpen, onClose, onSelectNodeType }: SideModalProps) {
  ...
  const [isFileOpsOpen, setIsFileOpsOpen] = useState(false); // All sections are closed by default
