...
//   // Load current workflow name from localStorage
//   useEffect(() => {
//     try {
...
//       }
//     } catch (error) {
//       console.error("Error loading current workflow name:", error)
//     }
//   }, [])
...
//         setCurrentWorkflowName(event.detail.name)
//       }
//     }
...
//           {currentWorkflowName && <div className="text-sm font-medium text-gray-700 mb-1">{currentWorkflowName}</div>}
