...
export function TopMenu({
  ...
  const [createCredentialsDialogOpen, setCreateCredentialsDialogOpen] =
    useState(false);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      addToast({
        ...
        message: "Your workflow has been saved.",
        type: "success",
      });
    } catch (error) {
  ...
  const handleCreateConfigs = async () => {
    ...
    try {
      ...
      addToast({
        title: "Error",
        message: "Failed to create configurations.",
        type: "error",
      });
    } finally {
  ...
  const handleRun = async () => {
    ...
    try {
      ...
      addToast({
        ...
        message: "The workflow has started successfully.",
        type: "info",
      });
    } catch (error) {
  ...
  const handleStop = async () => {
    ...
    try {
      ...
      addToast({
        title: "Error",
        message: "An error occurred while stopping the workflow.",
        type: "error",
      });
    } finally {
      setIsStopping(false);
  ...
  const handleDownloadWorkflow = () => {
    try {
      ...
      const filename = `${(exportData.metadata?.name || "workflow").replace(
        /[^a-zA-Z0-9]/g,
        "_"
      ...
      addToast({
        ...
        message: "Could not download the workflow file.",
        type: "error",
      });
    }
  };
    ...
    if (file) {
      ...
      reader.onload = (e) => {
        try {
          ...
          addToast({
            title: "Load Failed",
            message: "Please ensure it's a valid workflow file.",
            type: "error",
          });
        }
      };
                ...
                >
                  ...
                  <PopoverContent className="w-48 p-2" align="end">
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={handleCreateCredentialsClick}
                      className="justify-start w-full"
                    >
