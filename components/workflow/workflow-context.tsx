...
//   // NEW: Parse scheduler config function
//   const parseSchedulerConfig = useCallback((dagNode: any, basePosition: NodePosition) => {
//     console.log("Parsing scheduler config for node:", dagNode.id, dagNode.config)

//     const config = dagNode.config
//     if (!config) {
//       console.warn("No config found for scheduler node:", dagNode.id)
//       return { nodes: [], connections: [], firstNodeId: null, lastNodeId: null }
//     }

//     const schedulerNodeId = `scheduler_${dagNode.config_id || uuidv4()}`
//     console.log("Creating scheduler node:", schedulerNodeId, config)
...
//             dagNodeMapping.set(dagNode.id, { firstNodeId: fallbackNode.id, lastNodeId: fallbackNode.id })
//           }
//         } else if (dagNode.type === "scheduler" && dagNode.config) {
//           console.log("Processing scheduler node:", dagNode.id)
//           const parsed = parseSchedulerConfig(dagNode, defaultPosition)
...
//               })
//           } else {
//             console.warn("Failed to parse scheduler config for node:", dagNode.id)
//             const fallbackNode: WorkflowNode = {
//               id: dagNode.id,
//               type: "scheduler",
//               position: defaultPosition,
...
//       return { nodes: newNodes, connections: newConnections }
//     },
//     [parseFileConversionConfig, parseCliOperatorConfig, parseSchedulerConfig],
//   )
...
//     // Add scheduler-specific default data
//     if (type === "scheduler") {
...
//               is_active: true,
//               message: "Scheduler configuration ready for execution",
//               success: true,
//             }
//             break
//           case "end":
